      ...
      <div className="w-full sm:w-1/4 bg-blue-500 p-6 sm:block hidden">
        ...
        {status === "error" && (
          <button
            ...
            className="mt-2 px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 cursor-pointer"
          >
            Faire une action
          </button>
        )}
            ...
            {selectedTest && (
              <div className="mt-4 bg-gray-800 p-6 rounded-lg shadow-none">
                ...
                <button
                  ...
                  className="w-full py-2 px-4 bg-green-500 text-white rounded-md hover:bg-green-600 cursor-pointer"
                >
                  Lancer le test
                </button>
              </div>
      ...
      {showCorrectTestPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div className="bg-orange-500 p-6 rounded-lg shadow-lg text-white w-80">
            <h3 className="text-lg font-bold">Voulez-vous corriger le test ?</h3>
